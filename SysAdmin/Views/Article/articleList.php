                ...
                <div class="layui-table-tool">
                    <div class="layui-btn-container">
                        <?php if (isset($nav_mold[1])&&$nav_mold[1]==1):?>
                            <button class="layui-btn layui-btn-sm layui-btn-normal" onclick="javascript:open_window('<?=site_url("xccmssys/Article/form")?>','新增文章')" >新增</button>
                        <?php endif;?>
                    ...
                    <?php if (isset($nav_mold[2])||isset($nav_mold[3])):?>
                        <td style="width: 90px">
                            <?php if (isset($nav_mold[2])&&$nav_mold[2]==1):?>
                                <a class="layui-btn layui-btn-xs" lay-event="edit" href="javascript:open_window('<?=site_url("xccmssys/Article/form?id=".$row['id'])?>','编辑文章--<?=$row['label']?>')">修改</a>
                            <?php endif;?>
                            <?php if (isset($nav_mold[3])&&$nav_mold[3]==1):?>
...
<script>
    ...
    layui.use(['jquery', 'layer'], function () {
        ...
        window.del=function(){
            ...
            n="<?=base_url('xccmssys/Article/deleteArt')?>";
            delMsg2(x,n);
        }
