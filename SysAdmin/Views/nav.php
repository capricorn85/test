                ...
                <div class="layui-table-tool">
                    <div class="layui-btn-container">
                        <?php if (isset($nav_mold[1])&&$nav_mold[1]==1):?>
                            <button class="layui-btn layui-btn-sm layui-btn-normal" onclick="javascript:open_window('<?=base_url("xccmssys/nav/form")?>','新增栏目')" >新增</button>
                        <?php endif;?>
                    ...
                    <?php if (isset($nav_mold[2])||isset($nav_mold[3])):?>
                        <td>
                            ...
                            <?php if (isset($nav_mold[2])&&$nav_mold[2]==1):?>
                                <a class="layui-btn layui-btn-xs" lay-event="edit" href="javascript:open_window('<?=base_url("xccmssys/nav/form?id=".$row['id'])?>','编辑栏目--<?=$row['label']?>')">修改</a>
                            <?php endif;?>
                            <?php if (isset($nav_mold[3])&&$nav_mold[3]==1):?>
                ...
                <?php if(isset($row['child'])): ?>
                    <?php foreach($row['child'] as $row2): ?>
                        <tr>
                            ...
                            <td ><?=hp_cate_type($row2['n_type'])?></td>
                            <td ><?=$row2['target']?></td>
                            <td ><?=$row['label']?></td>
                            ...
                            <?php if (isset($nav_mold[2])||isset($nav_mold[3])):?>
                                <td >
                                    <div class="layui-btn-group">
                                    <?php if (isset($nav_mold[2])&&$nav_mold[2]==1):?>
                                        <a class="layui-btn layui-btn-xs" lay-event="edit" href="javascript:open_window('<?=base_url("xccmssys/nav/form?id=".$row2['id'])?>','编辑栏目--<?=$row2['label']?>')">修改</a>
                                    <?php endif;?>
                                    <?php if (isset($nav_mold[3])&&$nav_mold[3]==1):?>
                        ...
                        <?php if(isset($row2['child'])): ?>
                            <?php foreach($row2['child'] as $row3): ?>
                                <tr>
                                    ...
                                    <td ><?=hp_cate_type($row3['n_type'])?></td>
                                    <td ><?=$row3['target']?></td>
                                    <td ><?=$row2['label']?></td>
                                    ...
                                    <?php if (isset($nav_mold[2])||isset($nav_mold[3])):?>
                                        <td >
                                            <div class="layui-btn-group">
                                            <?php if (isset($nav_mold[2])&&$nav_mold[2]==1):?>
                                                <a class="layui-btn layui-btn-xs" lay-event="edit" href="javascript:open_window('<?=base_url("xccmssys/nav/form?id=".$row3['id'])?>','编辑栏目--<?=$row3['label']?>')">修改</a>
                                            <?php endif;?>
                                            <?php if (isset($nav_mold[3])&&$nav_mold[3]==1):?>
...
<script>
    ...
    <?php if (isset($nav_mold[3])&&$nav_mold[3]==1):?>
        ...
        n="<?=base_url('xccmssys/nav/deleteNav')?>";
        delMsg2(x,n);
    }
