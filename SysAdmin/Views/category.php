                ...
                <div class="layui-table-tool">
                    <div class="layui-btn-container">
                        <?php if (isset($nav_mold[1])&&$nav_mold[1]==1):?>
                            <button class="layui-btn layui-btn-sm layui-btn-normal" onclick="javascript:open_window('<?=site_url("adminSys/Category/form")?>','新增栏目')" >新增</button>
                        <?php endif;?>
                    ...
                    <?php if (isset($nav_mold[2])||isset($nav_mold[3])):?>
                        <td  style="width: 85px">
                            <?php if (isset($nav_mold[2])&&$nav_mold[2]==1):?>
                                <a class="layui-btn layui-btn-xs" lay-event="edit" href="javascript:open_window('<?=site_url("adminSys/Category/form?id=".$row['id'])?>','编辑栏目--<?=$row['cat_name']?>')">修改</a>
                            <?php endif;?>
                            <?php if (isset($nav_mold[3])&&$nav_mold[3]==1):?>
                    ...
                    <?php foreach($row['child'] as $row2): ?>
                        <tr>
                            ...
                            <?php if (isset($nav_mold[2])||isset($nav_mold[3])):?>
                                <td  style="width: 85px">
                                    <?php if (isset($nav_mold[2])&&$nav_mold[2]==1):?>
                                        <a class="layui-btn layui-btn-xs" lay-event="edit" href="javascript:open_window('<?=base_url("adminSys/Category/form?id=".$row2['id'])?>','编辑栏目--<?=$row2['cat_name']?>')">修改</a>
                                    <?php endif;?>
                                    <?php if (isset($nav_mold[3])&&$nav_mold[3]==1):?>
                            ...
                            <?php foreach($row2['child'] as $row3): ?>
                                <tr>
                                    ...
                                    <?php if (isset($nav_mold[2])||isset($nav_mold[3])):?>
                                        <td  style="width: 85px">
                                            <?php if (isset($nav_mold[2])&&$nav_mold[2]==1):?>
                                                <a class="layui-btn layui-btn-xs" lay-event="edit" href="javascript:open_window('<?=site_url("adminSys/Category/form?id=".$row3['id'])?>','编辑栏目--<?=$row3['cat_name']?>')">修改</a>
                                            <?php endif;?>
                                            <?php if (isset($nav_mold[3])&&$nav_mold[3]==1):?>
...
<script>
    ...
    layui.use(['jquery', 'layer'], function () {
        ...
        window.del=function(){
            ...
            n="<?=base_url('adminSys/Category/deleteCat')?>";
            delMsg2(x,n);
        }
