...
<!--            <p>欢迎进入触摸查询系统</p>-->
        ...
        <div class="nav-arrow lf"> <a href="<?=site_url('screen')?>"><img src="<?=base_url('asset/img/arrow_lf.png')?>" class="scalearrow"></a></div>
        <div class="nav-arrow rt"> <a href="<?=site_url('screen/navHomebs')?>"><img src="<?=base_url('asset/img/arrow_rt.png')?>" class="scalearrow"></a></div>
    </div>
</main>
